...
{
    default void distributeWork(int totalPoints, int numberOfWorkers)
    {
        distributeWork(totalPoints, numberOfWorkers, com.zeroc.Ice.ObjectPrx.noExplicitContext);
    }

    default void distributeWork(int totalPoints, int numberOfWorkers, java.util.Map<String, String> context)
    {
        _iceI_distributeWorkAsync(totalPoints, numberOfWorkers, context, true).waitForResponse();
    }

    default java.util.concurrent.CompletableFuture<Void> distributeWorkAsync(int totalPoints, int numberOfWorkers)
    {
        return _iceI_distributeWorkAsync(totalPoints, numberOfWorkers, com.zeroc.Ice.ObjectPrx.noExplicitContext, false);
    }

    default java.util.concurrent.CompletableFuture<Void> distributeWorkAsync(int totalPoints, int numberOfWorkers, java.util.Map<String, String> context)
    {
        return _iceI_distributeWorkAsync(totalPoints, numberOfWorkers, context, false);
    }

    /**
     * @hidden
     * @param iceP_totalPoints -
     * @param iceP_numberOfWorkers -
     * @param context -
     * @param sync -
     * @return -
     **/
    default com.zeroc.IceInternal.OutgoingAsync<Void> _iceI_distributeWorkAsync(int iceP_totalPoints, int iceP_numberOfWorkers, java.util.Map<String, String> context, boolean sync)
    {
        ...
        f.invoke(false, context, null, ostr -> {
                     ...
                     ostr.writeInt(iceP_numberOfWorkers);
                 }, null);
        return f;
    }

    default void reportResult(int pointsInsideCircle)
    {
        reportResult(pointsInsideCircle, com.zeroc.Ice.ObjectPrx.noExplicitContext);
    }

    default void reportResult(int pointsInsideCircle, java.util.Map<String, String> context)
    {
        _iceI_reportResultAsync(pointsInsideCircle, context, true).waitForResponse();
    }

    default java.util.concurrent.CompletableFuture<Void> reportResultAsync(int pointsInsideCircle)
    {
        return _iceI_reportResultAsync(pointsInsideCircle, com.zeroc.Ice.ObjectPrx.noExplicitContext, false);
    }

    default java.util.concurrent.CompletableFuture<Void> reportResultAsync(int pointsInsideCircle, java.util.Map<String, String> context)
    {
        return _iceI_reportResultAsync(pointsInsideCircle, context, false);
    }

    /**
     * @hidden
     * @param iceP_pointsInsideCircle -
     * @param context -
     * @param sync -
     * @return -
     **/
    default com.zeroc.IceInternal.OutgoingAsync<Void> _iceI_reportResultAsync(int iceP_pointsInsideCircle, java.util.Map<String, String> context, boolean sync)
    {
        com.zeroc.IceInternal.OutgoingAsync<Void> f = new com.zeroc.IceInternal.OutgoingAsync<>(this, "reportResult", null, sync, null);
        f.invoke(false, context, null, ostr -> {
                     ostr.writeInt(iceP_pointsInsideCircle);
                 }, null);
        return f;
    }
