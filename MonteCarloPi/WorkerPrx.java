...
{
    default void performCalculation(int assignedPoints)
    {
        performCalculation(assignedPoints, com.zeroc.Ice.ObjectPrx.noExplicitContext);
    }

    default void performCalculation(int assignedPoints, java.util.Map<String, String> context)
    {
        _iceI_performCalculationAsync(assignedPoints, context, true).waitForResponse();
    }

    default java.util.concurrent.CompletableFuture<Void> performCalculationAsync(int assignedPoints)
    {
        return _iceI_performCalculationAsync(assignedPoints, com.zeroc.Ice.ObjectPrx.noExplicitContext, false);
    }

    default java.util.concurrent.CompletableFuture<Void> performCalculationAsync(int assignedPoints, java.util.Map<String, String> context)
    {
        return _iceI_performCalculationAsync(assignedPoints, context, false);
    }

    /**
     * @hidden
     * @param iceP_assignedPoints -
     * @param context -
     * @param sync -
     * @return -
     **/
    default com.zeroc.IceInternal.OutgoingAsync<Void> _iceI_performCalculationAsync(int iceP_assignedPoints, java.util.Map<String, String> context, boolean sync)
    {
        com.zeroc.IceInternal.OutgoingAsync<Void> f = new com.zeroc.IceInternal.OutgoingAsync<>(this, "performCalculation", null, sync, null);
        f.invoke(false, context, null, ostr -> {
                     ostr.writeInt(iceP_assignedPoints);
                 }, null);
        return f;
    }
